...
- [x] เพิ่มวัสดุครั้งละหลายรายการ (ตารางกรอกหลายแถว / วางข้อมูลจาก Excel)
- [x] สต็อกคงเหลือ (Card / Table view)
- [x] รับวัสดุเข้าคลัง
- [x] เบิกวัสดุ + อนุมัติ (Workflow) พร้อมบันทึก "แผนกที่เบิก" จากบัญชีผู้ใช้
- [x] เบิกครั้งละหลายรายการในคำขอเดียว (ผูกด้วยเลขชุด แจ้งเตือนครั้งเดียว) และอนุมัติ/ปฏิเสธทั้งชุดได้ในคลิกเดียว
- [x] QR Code สำหรับเบิกวัสดุ (Generate + Print)
- [x] QR Scanner ด้วยกล้อง (html5-qrcode)
- [x] ประวัติเคลื่อนไหว + รายงาน
- [x] รายงานรายเดือน (Matrix) + สรุปยอดเบิกแยกตามแผนก
- [x] จัดการผู้ใช้งาน (กำหนดแผนก/ฝ่ายให้ผู้ใช้แต่ละคน)
- [x] แจ้งเตือน Telegram (ทุกหมวดหมู่) และ LINE (เลือกเฉพาะหมวดหมู่ + จำกัดจำนวนข้อความต่อเดือน)
